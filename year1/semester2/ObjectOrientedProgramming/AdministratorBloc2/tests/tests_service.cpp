...
void TestsService::test_filter_after_type() {
    ...
    MyVector<Locatar> filtered_list = ServiceLocatari::filter_after_type(srv.get_all_locatari(), "penthouse");
...
void TestsService::test_filter_after_surface() {
    ...
    MyVector<Locatar> fitered_list = ServiceLocatari::filter_after_surface(srv.get_all_locatari(), 100);
...
void TestsService::test_sort_after_name() {
    ...
    MyVector<Locatar>sorted_list = ServiceLocatari::sort_after_name(srv.get_all_locatari());
...
void TestsService::test_sort_after_surface() {
    ...
    MyVector<Locatar>sorted_list = ServiceLocatari::sort_after_surface(srv.get_all_locatari());
...
void TestsService::test_sort_after_type_and_surface() {
    ...
    MyVector<Locatar>sorted_list = ServiceLocatari::sort_after_type_and_surface(srv.get_all_locatari());
