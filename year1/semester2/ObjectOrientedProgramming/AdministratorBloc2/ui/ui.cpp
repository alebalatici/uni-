...
void Console::print_all_locatari(const MyVector<Locatar>& locatari) {
    if (locatari.empty()) {
...
void Console::filter_after_type_ui(const MyVector<Locatar>& list) {
    string type;
    cout << "Introduceti tipul dupa care sa se realizeze filtrarea:\n>>>";
    cin >> type;
    MyVector<Locatar>filtered_list = ServiceLocatari::filter_after_type(list, type);
    print_all_locatari(filtered_list);
}

void Console::filter_after_surface_ui(const MyVector<Locatar>& list) {
    ...
    MyVector<Locatar>filtered_list = ServiceLocatari::filter_after_surface(list, suprafata_minima);
    print_all_locatari(filtered_list);
}

void Console::sort_after_name_ui(const MyVector<Locatar>& list) {
    MyVector<Locatar>sorted_list = ServiceLocatari::sort_after_name(list);
    print_all_locatari(sorted_list);
}

void Console::sort_after_surface_ui(const MyVector<Locatar>& list) {
    MyVector<Locatar>sorted_list = ServiceLocatari::sort_after_surface(list);
    print_all_locatari(sorted_list);
}

void Console::sort_after_type_and_surface_ui(const MyVector<Locatar>& list) {
    MyVector<Locatar>sorted_list = ServiceLocatari::sort_after_type_and_surface(list);
    print_all_locatari(sorted_list);
}
