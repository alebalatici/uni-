...
void TestsService::test_undo()
{
    ...
    srv.add_locatar(16, "Ion", 50.5, "penthouse");
    assert(repo.get_all_locatari().size() == 16);

    srv.add_locatar(17, "Lavinia", 60.4, "apartament");
    assert(repo.get_all_locatari().size() == 17);
    ...
    srv.delete_locatar(1);
    assert(repo.get_all_locatari().size() == 14);

    srv.undo();
    assert(repo.get_all_locatari().size() == 15);

    srv.add_locatar(18, "Florin", 533.0, "garsoniera");
    assert(repo.get_all_locatari().size() == 16);

    srv.modify_locatar(18, "George", 560.0, "apartament");
    assert(repo.find_locatar(18).get_nume() == "George");
    assert(repo.find_locatar(18).get_suprafata() == 560.0);
    assert(repo.find_locatar(18).get_tip() == "apartament");

    srv.undo();
    assert(repo.find_locatar(18).get_nume() == "Florin");
    assert(repo.find_locatar(18).get_suprafata() == 533.0);
    assert(repo.find_locatar(18).get_tip() == "garsoniera");
}
